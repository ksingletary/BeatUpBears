        ...
        <div className="container">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0 ml-16 text-white">
              ...
              <p className='text-lg font-apercuRegular'>
                We also want to shout out our amazing community team consisting of Sophie Patel (community spaces lead), Liam Torres (chief meme officer), and Noah Davies (community safety lead).
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 ml-20">
            {teamMembers.map((member) => (
              <div key={member.id} className="bg-transparent shadow-lg hover:shadow-xl cursor-pointer transition-all duration-300 ease-in-out hover:-translate-y-2 transform-gpu rounded-lg overflow-hidden">
