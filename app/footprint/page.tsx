  ...
  return (
    <>
        ...
        <div className='min-h-[450px] flex flex-col justify-center bg-blackLight'>
            <div className='container pl-72 text-center font-apercuMedium space-y-8'>
        ...
        <div className="relative min-h-[650px]">
            <video 
              ...
              playsInline
            />
            <div className="absolute w-lvw ml-24 font-apercuBold z-10 space-y-5 flex flex-col items-center justify-center h-full text-center ">
        ...
        <div className="min-h-[850px] flex justify-center items-center bg-blackLight p-4 z-10">
            <div className="container ">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col w-full justify-center gap-6 sm:pt-0 ml-40 text-white ">
            ...
            <div className='container mx-auto space-y-36'>
                ...
                <div>
                    ...
                    <div className="mt-6 ml-10">
                        <h3 className="text-orange-500 font-apercuRegular text-2xl">Michael Linnington</h3>
                        <p className="text-white font-apercuRegular text-2xl">CEO OF Wounded Warriors</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="min-h-[850px] flex justify-center items-center bg-blackLight p-4 z-10">
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                    ...
                    {/* Text content section */}
                    <div className="flex flex-col justify-center w-full gap-6 sm:pt-0 ml-40 text-white">
        ...
        <div className='min-h-[420px] bg-blackLight'>
            <div className='container mx-auto flex flex-col justify-center' style={{ minHeight: '400px' }}>
                <div className='mb-28'>
                    ...
                    <div className="mt-6 ml-10">
                        <h3 className="text-orange-500 font-apercuRegular text-2xl">Cynthia Zagieboylo</h3>
                        <p className="text-white font-apercuRegular text-2xl">CEO OF MS Society</p>
                    </div>
                </div>
            </div>
        </div>
